 ...
 */
final class Version20250428160822 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE ecrire (id_document INT NOT NULL, IdAuteur INT NOT NULL, INDEX IDX_918824CC88B266E3 (id_document), INDEX IdAuteur (IdAuteur), PRIMARY KEY(id_document, IdAuteur)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
