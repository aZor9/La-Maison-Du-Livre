 ...
 */
final class Version20250320234741 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE emprunt CHANGE utilisateur_id idUtilisateur INT NOT NULL');
        $this->addSql('ALTER TABLE emprunt ADD CONSTRAINT FK_364071D75D419CCB FOREIGN KEY (idUtilisateur) REFERENCES utilisateur (idUtilisateur)');
        ...
        $this->addSql('ALTER TABLE emprunt_article ADD CONSTRAINT FK_118C0CCB12836594 FOREIGN KEY (idArticle) REFERENCES article (idArticle)');
        $this->addSql('ALTER TABLE emprunt_article ADD CONSTRAINT FK_118C0CCB26F91A25 FOREIGN KEY (idEmprunt) REFERENCES emprunt (idEmprunt)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE emprunt CHANGE idUtilisateur utilisateur_id INT NOT NULL');
