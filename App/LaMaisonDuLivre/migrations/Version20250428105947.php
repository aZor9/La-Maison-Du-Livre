 ...
 */
final class Version20250428105947 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE document (id_document INT AUTO_INCREMENT NOT NULL, titre VARCHAR(50) DEFAULT NULL, annee DATE DEFAULT NULL, descritpion LONGTEXT DEFAULT NULL, thème VARCHAR(50) DEFAULT NULL, type VARCHAR(255) NOT NULL, PRIMARY KEY(id_document)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('CREATE TABLE ecrire (id_document INT NOT NULL, IdAuteur INT NOT NULL, INDEX IDX_918824CCC497A3FD (id_document), INDEX IdAuteur (IdAuteur), PRIMARY KEY(id_document, IdAuteur)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        ...
        $this->addSql('CREATE TABLE exemplaire (IdExemplaire INT AUTO_INCREMENT NOT NULL, etat_physique VARCHAR(50) DEFAULT NULL, statut VARCHAR(50) DEFAULT NULL, id_document INT NOT NULL, INDEX id_document (id_document), PRIMARY KEY(IdExemplaire)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('CREATE TABLE livre (isbn VARCHAR(50) DEFAULT NULL, nombre_page INT DEFAULT NULL, genre VARCHAR(50) DEFAULT NULL, id_document INT NOT NULL, UNIQUE INDEX ISBN (ISBN), PRIMARY KEY(id_document)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('CREATE TABLE sonore (duree INT DEFAULT NULL, format VARCHAR(50) DEFAULT NULL, interprete VARCHAR(50) DEFAULT NULL, id_document INT NOT NULL, PRIMARY KEY(id_document)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('CREATE TABLE titreperiodique (numero INT DEFAULT NULL, date_publication DATE DEFAULT NULL, format VARCHAR(50) DEFAULT NULL, id_document INT NOT NULL, PRIMARY KEY(id_document)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('CREATE TABLE utilisateur (IdUtilisateur INT AUTO_INCREMENT NOT NULL, nom VARCHAR(50) DEFAULT NULL, prenom VARCHAR(50) DEFAULT NULL, date_naissance DATE DEFAULT NULL, adresse1 VARCHAR(50) DEFAULT NULL, adresse2 VARCHAR(50) DEFAULT NULL, ville VARCHAR(50) DEFAULT NULL, pays VARCHAR(50) DEFAULT NULL, mail VARCHAR(50) NOT NULL, numero_telephone VARCHAR(50) DEFAULT NULL, situation VARCHAR(50) DEFAULT NULL, role VARCHAR(50) DEFAULT NULL, lien_justificatif VARCHAR(5000) DEFAULT NULL, statut VARCHAR(50) DEFAULT NULL, motdepasse VARCHAR(255) NOT NULL, IdAbonnement INT DEFAULT NULL, INDEX IdAbonnement (IdAbonnement), PRIMARY KEY(IdUtilisateur)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('CREATE TABLE video (duree INT DEFAULT NULL, format VARCHAR(50) DEFAULT NULL, realisateur VARCHAR(50) DEFAULT NULL, id_document INT NOT NULL, PRIMARY KEY(id_document)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('CREATE TABLE messenger_messages (id BIGINT AUTO_INCREMENT NOT NULL, body LONGTEXT NOT NULL, headers LONGTEXT NOT NULL, queue_name VARCHAR(190) NOT NULL, created_at DATETIME NOT NULL, available_at DATETIME NOT NULL, delivered_at DATETIME DEFAULT NULL, INDEX IDX_75EA56E0FB7336F0 (queue_name), INDEX IDX_75EA56E0E3BD61CE (available_at), INDEX IDX_75EA56E016BA31DB (delivered_at), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('ALTER TABLE ecrire ADD CONSTRAINT FK_918824CCC497A3FD FOREIGN KEY (id_document) REFERENCES document (id_document) ON DELETE CASCADE');
        ...
        $this->addSql('ALTER TABLE exemplaire ADD CONSTRAINT FK_5EF83C92C497A3FD FOREIGN KEY (id_document) REFERENCES document (id_document)');
        $this->addSql('ALTER TABLE livre ADD CONSTRAINT FK_AC634F99C497A3FD FOREIGN KEY (id_document) REFERENCES document (id_document) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE sonore ADD CONSTRAINT FK_9FB5BCDEC497A3FD FOREIGN KEY (id_document) REFERENCES document (id_document) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE titreperiodique ADD CONSTRAINT FK_13BCEF62C497A3FD FOREIGN KEY (id_document) REFERENCES document (id_document) ON DELETE CASCADE');
        ...
        $this->addSql('ALTER TABLE video ADD CONSTRAINT FK_7CC7DA2CC497A3FD FOREIGN KEY (id_document) REFERENCES document (id_document) ON DELETE CASCADE');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE titreperiodique');
