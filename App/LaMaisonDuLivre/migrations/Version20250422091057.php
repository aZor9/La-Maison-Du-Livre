 ...
 */
final class Version20250422091057 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE auteur MODIFY IdAuteur INT NOT NULL');
        $this->addSql('DROP INDEX `primary` ON auteur');
        $this->addSql('ALTER TABLE auteur CHANGE Description description LONGTEXT DEFAULT NULL, CHANGE IdAuteur id_auteur INT AUTO_INCREMENT NOT NULL');
        $this->addSql('ALTER TABLE auteur ADD PRIMARY KEY (id_auteur)');
        $this->addSql('ALTER TABLE document MODIFY IdDocument INT NOT NULL');
        $this->addSql('DROP INDEX `primary` ON document');
        $this->addSql('ALTER TABLE document DROP Auteur, CHANGE Descritpion descritpion LONGTEXT DEFAULT NULL, CHANGE IdDocument id_document INT AUTO_INCREMENT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX `PRIMARY` ON document');
        $this->addSql('ALTER TABLE document ADD Auteur VARCHAR(50) DEFAULT NULL, CHANGE descritpion Descritpion TEXT DEFAULT NULL, CHANGE id_document IdDocument INT AUTO_INCREMENT NOT NULL');
        $this->addSql('ALTER TABLE document ADD PRIMARY KEY (IdDocument)');
        $this->addSql('DROP INDEX `PRIMARY` ON sonore');
        ...
        $this->addSql('DROP INDEX `PRIMARY` ON auteur');
        $this->addSql('ALTER TABLE auteur CHANGE description Description TEXT DEFAULT NULL, CHANGE id_auteur IdAuteur INT AUTO_INCREMENT NOT NULL');
        $this->addSql('ALTER TABLE auteur ADD PRIMARY KEY (IdAuteur)');
