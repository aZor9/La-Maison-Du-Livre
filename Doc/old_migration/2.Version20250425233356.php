...
final class Version20250425233356 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE document (IdDocument INT AUTO_INCREMENT NOT NULL, titre VARCHAR(50) DEFAULT NULL, annee DATE DEFAULT NULL, descritpion LONGTEXT DEFAULT NULL, theme VARCHAR(50) DEFAULT NULL, type VARCHAR(255) NOT NULL, isbn VARCHAR(50) DEFAULT NULL, nombre_page INT DEFAULT NULL, genre VARCHAR(50) DEFAULT NULL, numero INT DEFAULT NULL, date_publication DATE DEFAULT NULL, format VARCHAR(50) DEFAULT NULL, duree INT DEFAULT NULL, realisateur VARCHAR(50) DEFAULT NULL, interprete VARCHAR(50) DEFAULT NULL, PRIMARY KEY(IdDocument)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
