 ...
 */
final class Version20250423134646 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE document (IdDocument INT AUTO_INCREMENT NOT NULL, titre VARCHAR(50) DEFAULT NULL, annee DATE DEFAULT NULL, descritpion LONGTEXT DEFAULT NULL, theme VARCHAR(50) DEFAULT NULL, type VARCHAR(255) NOT NULL, PRIMARY KEY(IdDocument)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        ...
        $this->addSql('CREATE TABLE video (duree INT DEFAULT NULL, format VARCHAR(50) DEFAULT NULL, realisateur VARCHAR(50) DEFAULT NULL, IdDocument INT NOT NULL, PRIMARY KEY(IdDocument)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
